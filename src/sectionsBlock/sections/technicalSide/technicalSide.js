  ...
  return (
    <div className="containerTechnicalSide">
      ...
      <div>
        ...
        распределённый реестр, который называется <span style={{fontStyle: 'italic'}}>блокчейн</span> — цепочка из блоков с
      ...
      <div className="blockchainBlock">
        ...
        <div className="infoBlockchain">
          ...
          <div id="animateBlock3">
            ...
            <div>
              ...
              абсолютно полной и верной, в блокчейне ввели понятие <span style={{fontStyle: 'italic'}}>консенсус</span>
        ...
        <div className="infoBlockchain">
          ...
          <div>
            ...
            <div>
              ...
              хорошо описаны на <a href={"https://habr.com/ru/company/waves/blog/402257/"}>этом сайте</a>.
            </div>
          </div>
        </div>
        <div className="infoBlockchain">
        ...
        <div className="infoBlockchain">
          ...
          <div id="animateBlock5">
            ...
            <div>
              ...
              владельца. Новые блоки в цепь добавляют <span style={{fontStyle: 'italic'}}>майнеры</span>.
            </div>
          </div>
        </div>
        <div className="infoBlockchain">
        ...
        <div className="infoBlockchain">
          ...
          <div id="animateBlock7">
            <div className="titleBlockchain">Кошелёк</div>
            <div>
              Пользователи криптовалют используют специальные программные или
              аппаратные <a href={"https://www.rbc.ru/crypto/news/601518f29a79471424899d99"}>кошельки</a>. Каждый такой кошелёк содержит в себе
              ...
              интересную схему безопасности — для каждой операции кошелёк
              создает новые уникальные адреса.
            </div>
            <div>
              При этом кошельки могут быть как «горячими» — то есть размещаться
              где-то в интернете в рамках <a href={"https://holytransaction.com/"}>онлайн-сервиса</a>, так и «холодными» —
      ...
      <div>
        Если вы хотите узнать больше о технической стороне криптовалют,
